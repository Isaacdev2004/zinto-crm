...
const App = () => {
  ...
  const appColorLocalStorage = localStorage.getItem("primaryColorLight") || localStorage.getItem("primaryColorDark") || "#4F46E5";
  ...
  useEffect(() => {
    ...
    getPublicSetting("primaryColorLight")
      .then((color) => {
        setPrimaryColorLight(color || "#4F46E5");
      })
      .catch((error) => {
    ...
    getPublicSetting("primaryColorDark")
      .then((color) => {
        setPrimaryColorDark(color || "#3730A3");
      })
      .catch((error) => {
        console.log("Error reading setting", error);
      });
